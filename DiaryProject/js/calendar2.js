...
var selectMonth = document.getElementById("month2");

var createYear = generate_year_range(1970, 2200);

document.getElementById("year2").innerHTML = createYear;
...
function jump2() {
  ...
  calendar.Selected.Month = currentMonth.
  createCalendar(calendar,elment,adjuster);
}
